    ...
    return (
        ...
        <ul className='w-screen ml-8 flex gap-14 pt-4'>
            ...
            transition={{duration:1.5}}
             ...
             whileInView={{opacity:1 , y:0}}
             transition={{duration:1.5}}
              className=' backdrop-blur-sm shadow-md mt-2 bg-white/5  w-fit h-fit p-2 pr-5 pl-5 cursor-pointer rounded-full hover:scale-105 hover:transition-colors hover:bg-white'><p className='font-textfont text-sky-600'>Signup</p></motion.div>

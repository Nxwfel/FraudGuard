...
const hide = () => {
    document.getElementById('User-Page').style.top = '-34rem';
    ...
    transition={{ duration: 1.3 }}> 
        <div className='background2 bg-background2 bg-cover bg-center h-screen w-screen'>
           ...
           <motion.div
                ...
                className='hidden absolute top-32 left-1/3 max-md:left-40 max-sm:left-14 w-96 h-3/5 rounded-lg bg-white z-50 items-center justify-center text-center'
                id='User-Page'
                >
              ...
              className='hidden absolute h-56 w-fit right-4 -mt-14  ml-auto flex justify-center items-center cursor-pointer'
              onClick={Popup}
              role="button"
              >

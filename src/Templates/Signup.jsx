...
const Signup = () => {
  return (
    ...
    <div class="flex items-start mb-6">
        ...
        <input id="remember" type="checkbox" value="" class="w-4 h-4 mt-5 ml-12 border border-gray-300 rounded-sm bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" required />
        </div>

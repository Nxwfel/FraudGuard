    ...
    return (
        ...
        <ul className='w-screen ml-8 flex gap-14 pt-4'>
            ...
            transition={{duration:1.5}}
             className='ml-96 right-0 mt-2 backdrop-blur-sm shadow-md bg-white/5  w-fit h-fit p-2 pr-5 pl-5 cursor-pointer rounded-full hover:scale-105 transition-transform hover:bg-white'><p className='font-textfont text-sky-600'>Login</p></motion.div>
